...
Route::group(['namespace' => 'Web\Back\App', 'prefix' => 'app', 'as' => 'app:'], function () {
     ...
     */
    Route::get('/', 'DashboardController@index')->name('dashboard');
    Route::get('/notification/{id}', 'DashboardController@read')->name('project.notification.read');
    ...
    Route::post('projects/{project}/approve', 'Projects\CompleteProjectsController@approve')->name('projects.complete.approve');
    Route::post('projects/{project}/unapprove', 'Projects\CompleteProjectsController@unapprove')->name('projects.complete.unapprove');
    ...
    Route::patch('projects/{project}/tasks/{task}', 'Projects\ProjectTasksController@approve')->name('project.tasks.approve');

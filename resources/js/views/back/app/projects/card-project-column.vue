        ...
        <div class="flex flex-col h-full rounded-lg shadow-sm bg-gray-200">
            ...
            <div class="flex flex-col h-full px-4 overflow-y-auto">
                <div class="flex flex-col mb-4 mt-1" v-if="addTaskForm.visible">
                    <input @keyup.enter="storeTask()" class="form-input" placeholder="Write task" ref="input_new_task"
                    ...
                    <div class="flex justify-end mt-3">
                        ...
                        <button :disabled="addTaskForm.content === null" @click="storeTask()"
                            class="btn btn-blue text-xs px-4 py-1" type="button">
                            {{ $trans('labels.submit') }}
                        </button>
                    </div>
                </div>

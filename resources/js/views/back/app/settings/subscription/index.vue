                                ...
                                <dl>
                                    <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                        ...
                                        <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                                            <span v-if="$page.subscription.plan.name">{{ $page.subscription.plan.name
                                            }}</span>
                                            <span v-else>-</span>
                                        </dd>
                                    </div>
                        ...
                        <div class="bg-white shadow rounded-lg mb-6">
                            ...
                            <div class="px-4 sm:px-6 pb-6">
                                <template v-for="paymentMethod in $page.paymentMethods">
                                    <v-card-payment-method-credit-card :key="paymentMethod.token"
                                        :token="paymentMethod.token" :last-four="paymentMethod.last4"
                                        :exp-month="paymentMethod.expMonth" :exp-year="paymentMethod.expYear"
                                        :is-default="paymentMethod.default" :brand="paymentMethod.brand"
                                ...
                                <a @click.prevent="showAddPaymentMethodModal()" href="#"
                                    class="flex items-center justify-center text-sm rounded-lg border-2 border-dotted py-4 hover:border-gray-400 transition ease-in-out duration-150">
                            ...
                            <div class="px-4 sm:px-6 pb-6" v-for="plan in $page.plans">
                                <div class="rounded-md bg-gray-50 px-6 py-5 sm:flex sm:items-start sm:justify-between">
                                    ...
                                    <div class="mt-4 sm:mt-0 sm:ml-6 sm:flex-shrink-0">
                                        ...
                                        <button @click="showCancelSubscriptionModal(plan)" type="button"
                                            class="btn btn-link text-red-600" v-else>

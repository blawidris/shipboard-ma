<template>
    <div class="flex flex-col rounded-lg shadow-sm border border-gray-300">
        <v-textarea-exapandable class="border-none shadow-none focus:outline-none focus:shadow-none rounded-lg"
            :placeholder="$trans('placeholders.write-something')" v-model="content" @input="$emit('input', content)" />

<template>
    <div id="app" class="h-screen flex overflow-hidden bg-gray-100" v-cloak>
        ...
        <div class="md:hidden">
            ...
            <div class="fixed inset-y-0 left-0 flex flex-col z-40 max-w-xs w-full bg-gray-800 transform ease-in-out duration-300 "
...
<script>
import VNavMenu from '@/views/back/app/layouts/nav-menu'

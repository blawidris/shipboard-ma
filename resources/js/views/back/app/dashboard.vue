<template>
    <v-app-default-layout :pageTitle="$trans('headings.dashboard')">

        <template #header>
            <v-nav-header :pageTitle="$trans('headings.dashboard')" class="container mx-auto"></v-nav-header>
        </template>
        <!-- <template v-slot:header> -->
        <!-- <v-nav-header></v-nav-header> -->
        ...
        <template>
            <div class="container mx-auto px-4 sm:px-6 md:px-8 xl:px-8 py-4">
                <div class="mt-5 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-6">
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 bg-indigo-500 text-white rounded-md p-3">
                                    <svg class="h-6 w-6 fill-current" role="img" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512">
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 bg-indigo-500 text-white rounded-md p-3">
                                    <svg class="h-6 w-6 text-white" role="img" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512">
                                        <path fill="currentColor"
                        ...
                        <div class="bg-gray-50 px-4 py-4 sm:px-6">
                            <div class="text-sm leading-5">
                                <inertia-link :href="route('app:tasks.index', { filter: 'completed' })"
                                    class="font-medium text-indigo-600 hover:text-indigo-500 transition ease-in-out duration-150">
                                    {{ $trans('labels.view-all') }}
                                </inertia-link>
                            </div>
                    ...
                    <div class="flex flex-col bg-white rounded-lg shadow">
                        <div class="p-4">
                            <div class="font-semibold">
                                ...
                                <span class="border-b-2 border-indigo-300" v-if="$page.tasks_by_month_count > 0">{{
                                    $page.most_productive_month }}</span>
                                <span v-else>-</span>
                            </div>
                        </div>

                        <div class="p-4">
                            <v-chart-line :data="productiveMonthChart.data" :height="400"
                    ...
                    <div class="flex flex-col bg-white rounded-lg shadow">
                        <div class="p-4">
                            <span class="font-semibold">
                                ...
                                <span class="border-b-2 border-indigo-300" v-if="$page.tasks_by_day_count > 0">{{
                                    $page.most_productive_day }}</span>
                                <span v-else>-</span>
                            </span>
                        </div>

                        <div class="p-4">
                            <v-chart-line :data="productiveDayChart.data" :height="400"
